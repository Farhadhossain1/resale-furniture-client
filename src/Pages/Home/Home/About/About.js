        ...
        <div>
            ...
            <div className="hero-content flex-col lg:flex-row">
                <div className='relative w-1/2'>
                    ...
                    <img src={about2}  alt="" className="absolute right-5 top-1/2 w-3/5 border-8 rounded-lg shadow-2xl" />
                </div>
                <div className='w-1/2'>
                    <p className="text-3xl font-bold text-primary py-12">About Us</p>
                    <h1 className="my-5 text-5xl font-bold font-serif">
                    A better zone to <br /> shop <br /> for furniture !!!</h1>
